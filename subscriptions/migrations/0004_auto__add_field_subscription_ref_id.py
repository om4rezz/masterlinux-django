...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.ref_id'
        db.add_column(u'subscriptions_subscription', 'ref_id',
                      self.gf('django.db.models.fields.CharField')(default='ABC', max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.ref_id'
        db.delete_column(u'subscriptions_subscription', 'ref_id')
